...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/home/index.vue?vue&type=template&id=32a82820&
...
// CONCATENATED MODULE: ./pages/home/index.vue?vue&type=template&id=32a82820&
...
/* harmony default export */ var homevue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const loadArticles = store.state.user && tab === 'your_feed' ? api_article["f" /* getFeedArticles */] : api_article["e" /* getArticles */];
    ...
    const tags = tagsRes.data.tags.splice(0, 10);
    articles.forEach(article => article.favortiedDisabled = false);
    return {
      articles,
      articlesCount,
      tags,
  ...
  methods: {
    async onFavorite(article) {
      article.favortiedDisabled = true;
      ...
      article.favortiedDisabled = false;
    }
